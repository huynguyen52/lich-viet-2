...
function alertDayInfo(dd, mm, yy, leap, jd, sday, smonth, syear) {
  console.log(dd, mm, yy, leap, jd, sday, smonth, syear);
  console.log(getLunarDate(6, 5, 2022));
  var lunar = new LunarDate(dd, mm, yy, leap, jd);
  var s = getDayString(lunar, sday, smonth, syear); // Thứ sáu 6/5/2022 -+- Ngày 6 tháng 4
  s += ' âm lịch\n';
  s += 'Ngày ' + getDayName(lunar).ngay; // Ngày Kỷ Mùi, tháng Ất Tỵ, năm Nhâm Dần
